...
// https://github.com/Steveice10/MCProtocolLib/blob/master/src/main/java/org/spacehq/mc/protocol/data/game/chunk/FlexibleStorage.java
public class FlexibleStorage {
  ...
  public boolean equals(Object o) {
    return this == o || (o instanceof FlexibleStorage && Arrays
        .equals(this.data, ((FlexibleStorage) o).data)
        && this.bitsPerEntry == ((FlexibleStorage) o).bitsPerEntry
        && this.size == ((FlexibleStorage) o).size
