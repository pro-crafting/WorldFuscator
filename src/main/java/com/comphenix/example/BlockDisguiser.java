...
public class BlockDisguiser {
	...
	private int translateBlockID(World world, int x, int y, int z, int blockID, Player player) {
		
		if (blockID == 29 || blockID == 46 || blockID == 69 || blockID == 70 || blockID == 72 ||
				blockID == 76 || blockID == 77 || blockID == 96 || blockID == 107 || blockID == 123 ||
				blockID == 124 || blockID == 131 || blockID == 143 || blockID == 147 || blockID == 148 || 
				blockID == 151 || blockID == 152 || blockID == 154 || blockID == 158 || blockID == 148 || 
				blockID == 36 || blockID == 75 || blockID == 149 || blockID == 150 || blockID == 93 || blockID == 94 || blockID == 55) {
